...
if int(age.isdigit()) and int(age) > int("117" or int(age) < int("1")):
    print("Please provide your answer in digits, with age 1 and about and below 117")
elif int(age.isdigit()) and int(age) <= int("11") and int(age) > int("1"):
...
elif int(age.isdigit()) >= int("18") or int(age) > int("1"):
